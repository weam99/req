            ...
            SizedBox(
              ...
              child: ListView(
                children: [
                  ...
                  mainpart(getWidth(context),getHeight(context),       'Number of files',       '4 file', orientation == Orientation.portrait),


                  SizedBox(
                    width: getWidth(context),
                    height: orientation == Orientation.portrait?  getHeight(context)/5 :getHeight(context)/2,
                    ...
                    child: ListView.separated(
                      itemBuilder: (BuildContext context, int index) {
                        return   Container(
                          ...
                          width: double.infinity,
                          height: orientation == Orientation.portrait? getHeight(context)/15 : getHeight(context)/6 ,
                          decoration: BoxDecoration(
                              color: Colors.white,
                              border: Border.all(width: 1,color: Colors.white,),
                              borderRadius: BorderRadius.circular(10,)
                                ...
                                child: Row(
                                  ...
                                  children: [
                                   index==1? Image.asset(
                                     ...
                                     width:orientation == Orientation.portrait?  getHeight(context)/29: getHeight(context)/8 ,
                                     height:orientation == Orientation.portrait?  getHeight(context)/29: getHeight(context)/8 ,
                        ...
                        height: 0,
                               ...
                               Icon(SolarIconsOutline.downloadMinimalistic,
                                color: Colors.blue,
                                size: orientation == Orientation.portrait?  getHeight(context)/29: getHeight(context)/11 ,
