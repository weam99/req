      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
                height:orientation == Orientation.portrait? getHeight(context)/1.7 : getHeight(context)/5,
              ...
              child: ListView.separated(
                    ...
                    Stack(
                      children:[
                        Container(
                          ...
                          height:  orientation == Orientation.portrait?  getHeight(context)/3 : getHeight(context),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding:  EdgeInsets.only(left: getWidth(context)/30,top:getHeight(context)/40 ),
                                child: Image.asset(

                                  alignment:Alignment.centerLeft,
                                  ImageAssets.Imagetranslation,
                                  width:getWidth(context),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: getWidth(context)/60,),
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      elevation: 0,
                                      primary: Color.fromARGB(255, 197, 234,255 ),
                                      padding: EdgeInsets.symmetric(horizontal: getWidth(context) / 22, vertical:getHeight(context)/92 ),
                                    ),


                                    onPressed: (){

                                     index==1? Navigator.of(context).push(MaterialPageRoute(builder: (context) => request3()))  :

                                     Navigator.of(context).push(MaterialPageRoute(builder: (context) => request2()));
                       ...
                       Positioned(
                         ...
                         child: Container(
                           ...
                           height: orientation == Orientation.portrait?getHeight(context)/25:getHeight(context)/7,
                           decoration: BoxDecoration(
                ...
                separatorBuilder: (BuildContext context, int index) {
                  ...
                  return SizedBox(
                    ...
                    height:orientation == Orientation.portrait? getHeight(context)/50:getHeight(context)/13,
                  );
                },
                itemCount: 3,
